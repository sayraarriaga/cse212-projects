...
public static class ArraysTester {
    ...
    private static void RotateListRight(List<int> data, int amount)
    {
        ...
        // 1-create a loop for the data list, declaring the variable int "j", and using as condition the lenght of data list".
        // 2-Find the index of amount
        // 3-Use the Reverse method, using the index of amount and the size of the list
